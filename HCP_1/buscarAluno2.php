...
/* 
 * +++ BUSCA ALUNO DO ATALHO DA TABELA DO COORDENADOR (JA TEM O ID DO ALUNO) ***
...
$queryid1="SELECT * FROM horasComplementares.USER where id='$matricula'";
 ...
 echo '<a href="relatorio.php?var='.$matricula.'" ><input type="button" size="5" name="$dado4[0]" value="GERAR RELATORIO"></a> <a href="mensagem.php?var='.$matricula.'" ><input type="button" size="5" name="$dado4[0]" value="ENVIAR MENSAGEM"></a>'  
?>
...
//echo '<td><a href="editSubmissao.php?var='.$dado4[0].'" target="_blank"><input type="button" size="5" name="$dado4[0]" value="Edit"></a></td>';
