<html>
    ...
    <body class="user">
        <header id="hAluno" class="headerText">
            ...
            <br> 
 <a href="buscarAluno.php" target="_blank"><input type="Submit" value="SUBMETER" name="nSubMatricula" /></a>
                    </form>
            </fieldset>
        </header>
...
<?php
/* 
 *  *** ESTA BUSCA POR ALUNOS NAO CADASTRADOS COMO FORMANDOS NA INTERFACE DO COORDENADOR ***
...
if (($matricula = $_POST["nMatricula"])==0) {
    ...
    $matricula2=$dado[0];
        ...
        echo '<br><br><br><br><br><a href="relatorio.php?var='.$matricula2.'" ><input type="button" size="5" name="$dado[0]" value="GERAR RELATORIO"></a> 
     <a href="mensagem.php?var='.$matricula2.'" ><input type="button" size="5" name="$dado4[0]" value="ENVIAR MENSAGEM"></a> 
         <a href="addFormando.php?var='.$matricula2.'" ><input type="button" size="5" name="$dado4[0]" value="Marcar como FORMANDO"></a>
         <div id="dDadosAluno">
